// This file is a copy of the original with minor changes due to requirement from ManifestRTPSink
// Some private members are changed to protected members.
...
#define _DENSE_MULTI_FRAMED_RTP_SINK_HH
...
class DenseMultiFramedRTPSink : public DenseRTPSink
{
public:
...
protected:
  ...
  virtual ~DenseMultiFramedRTPSink();
...
protected: // Dense: This was changed from private to protected.
...
#endif // _DENSE_MULTI_FRAMED_RTP_SINK_HH
