...
#ifndef _DENSE_SIMPLE_RTP_SOURCE_HH
#define _DENSE_SIMPLE_RTP_SOURCE_HH

#ifndef _DENSE_MULTI_FRAMED_RTP_SOURCE_HH
#include "DenseMultiFramedRTPSource.hh"
#endif

class DenseSimpleRTPSource : public DenseMultiFramedRTPSource
{
public:
  static DenseSimpleRTPSource *createNew(UsageEnvironment &env, Groupsock *RTPgs,
...
protected:
  DenseSimpleRTPSource(UsageEnvironment &env, Groupsock *RTPgs,
                  unsigned char rtpPayloadFormat,
                  unsigned rtpTimestampFrequency,
                  char const *mimeTypeString, unsigned offset,
                  Boolean doNormalMBitRule);
  // called only by createNew(), or by subclass constructors
  virtual ~DenseSimpleRTPSource();
