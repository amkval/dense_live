...
// This is a copy of the original Live file, and is needed because
// MultiframedRTPSource is heavily modified.
...
DenseSimpleRTPSource *DenseSimpleRTPSource::createNew(
...
Boolean DenseSimpleRTPSource::processSpecialHeader(
...
char const *DenseSimpleRTPSource::MIMEtype() const
{
  if (fMIMEtypeString == NULL)
    return DenseMultiFramedRTPSource::MIMEtype();
